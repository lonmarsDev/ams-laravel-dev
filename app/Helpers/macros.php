...
#steven
Form::macro('generateCode', function ($default, $value) {
    $out = '<div class="generateCode" id="input-' . $value . '">
        
            <input type="text" class="form-control access_code" name="code" placeholder="Access Code" maxlength="10" value="'.$default.'">
    </div>';
