...
class EventQrcodeCheckInController extends Controller
{
    ...
    public function validateQRCode($event_id, Request $request){
        ...
        $attendee_log = new Attendee_log;

        $attendee_log->log = Carbon::now();
        $attendee_log->log_type = 1;
        $attendee_log->attendee_id = $attendee->id;
