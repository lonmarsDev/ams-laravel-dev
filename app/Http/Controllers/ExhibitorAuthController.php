...
class ExhibitorAuthController extends Controller
{
    ...
    public function showLogin(Request $request)
    {
        ...
        */
        ...
        return View::make('Public.LoginAndRegisterExhibitor.Login');
    }
    ...
    public function postLogin(Request $request)
    {
        ...
        if ($this->auth->attempt(['email' => $email, 'password' => $password , 'role' => 1 ], true) === false) {
            return Redirect::back()
        ...
        //return redirect('/exhibitors/dashboard');
    } 
}