...
Route::group(['middleware' => ['installed']], function () {
    ...
    Route::get('exhibitors/signup/confirm_email/{confirmation_code}', [
        'as'   => 'confirmEmailExhibitor',
        'uses' => 'UserSignupController@confirmEmailExhibitor',
    ]);
...
Route::group(['prefix' => 'e'], function () {
    ...
    #steven
    Route::post('{event_id}/promo/create', [
        'as'   => 'postSubmitPromo',
        'uses' => 'EventCheckoutController@postSubmitPromo',
    ]);
...
Route::group(['middleware' => ['auth', 'first.run']], function () {
    ...
    Route::group(['prefix' => 'organiser'], function () {
        ...
        #steven
        Route::get('access_code_generator', function () {
        ...
        return response()->json(array('generated_code'=> $string), 200);
       });
    ...
    Route::group(['prefix' => 'attendee'], function () {
        ...
        Route::get('{attendee_id}/dashboard', [
            'as'   => 'showAttendeeDashboard',
            'uses' => 'AttendeeController@showDashboard',
        ]);
        Route::get('{attendee_id}/{event_id}/event', [
            'as'   => 'showAttendeeEvent',
            'uses' => 'AttendeeController@showEvent',
        ]);
    });
    ...
    Route::group(['prefix' => 'event'], function () {
        ...
        Route::get('{event_id}/exhibitors/', [
            'as'   => 'showEventExhibitors',
            'uses' => 'EventExhibitorsController@showExhibitors',
        ]);

        Route::get('{event_id}/exhibitors/invite', [
            'as'   => 'showInviteExhibitor',
            'uses' => 'EventExhibitorsController@showInviteExhibitor',
        ]);

         Route::post('{event_id}/exhibitors/invite', [
            'as'   => 'postInviteExhibitor',
            'uses' => 'EventExhibitorsController@postInviteExhibitor',
        ]);

        Route::get('{event_id}/exhibitors/resend_ticket', [
            'as'   => 'showResendTicketToExhibitor',
            'uses' => 'EventExhibitorsController@showResendTicketToExhibitor',
        ]);

        Route::post('{event_id}/exhibitors/resend_ticket', [
            'as'   => 'postResendTicketToExhibitor',
            'uses' => 'EventExhibitorsController@postResendTicketToExhibitor',
        ]);

        Route::get('{event_id}/exhibitors/{exhibitor_id}/edit', [
            'as'   => 'showEditExhibitor',
            'uses' => 'EventExhibitorsController@showEditExhibitor',
        ]);

        Route::post('{event_id}/exhibitors/{attendee_id}/edit', [
            'as'   => 'postEditExhibitor',
            'uses' => 'EventExhibitorsController@postEditExhibitor',
        ]);

        Route::get('{event_id}/exhibitors/{attendee_id}/cancel', [
            'as'   => 'showCancelExhibitor',
            'uses' => 'EventExhibitorsController@showCancelExhibitor',
        ]);

        Route::post('{event_id}/exhibitors/{attendee_id}/cancel', [
            'as'   => 'postCancelExhibitor',
            'uses' => 'EventExhibitorsController@postCancelExhibitor',
        ]);
        /*
        ...
        */
        ...
        Route::post('{event_id}/qrcode_validate', [
            'as'   => 'postValidateQRCode',
            'uses' => 'EventQrcodeCheckInController@validateQRCode',
        ]);
...
Route::get('/exhibitors', function () {
    return Redirect::route('TheExhibitorDashboard');
});

Route::get('/exhibitors/login', [
    'as'   => 'Exhibitorlogin',
    'uses' => 'ExhibitorAuthController@showLogin',
]);

Route::post('/exhibitors/login', 'ExhibitorAuthController@postLogin');

Route::any('/exhibitors/logout', [
    'uses' => 'UserLogoutExhibitorController@doLogout',
    'as'   => 'logoutExhibitor',
]);


Route::group(['middleware' => ['auth.exhibitor']], function () {
    
    Route::group(['prefix' => 'exhibitors'], function () {

        Route::get('{organiser_id}/dashboard', [
            'as'   => 'showExhibitors',
            'uses' => 'ExhibitorDashboardController@showDashboard',
        ]);
     

        Route::get('{organiser_id}/create', [
            'as'   => 'showCreateExhibitor',
            'uses' => 'ExhibitorController@showCreateExhibitor',
        ]);
        Route::post('add', [
            'as'   => 'postCreateExhibitor',
            'uses' => 'ExhibitorController@postCreateExhibitor',
        ]);

       
        
        Route::get('/dashboard', [
            'as'   => 'showExhibitorDashboard',
            'uses' => 'ExhibitorDashboardController@showDashboard',
        ]);

        Route::get('/exhibitdashboard', [
            'as'   => 'TheExhibitorDashboard',
            'uses' => 'ExhibitorDashboardController@ExhibitorDashboard',
        ]);

         Route::get('/events', [
            'as'   => 'showExhibitorEvents',
            'uses' => 'ExhibitorEventsController@showEvents',
        ]);

        
        Route::get('/', [
            'as'   => 'showEditUserExhibitor',
            'uses' => 'UserController@showEditUserExhibitor',
        ]);
        Route::post('/', [
            'as'   => 'postEditUserExhibitor',
            'uses' => 'UserController@postEditUserExhibitor',
        ]);
        ...
        Route::group(['prefix' => 'events'], function () { 
            ...
            Route::get('{event_id}/dashboard/', [
                'as'   => 'showEventExhibitorDashboard',
                'uses' => 'EventDashboardExhibitorController@showDashboard',
            ]);

            Route::get('{event_id}/attendees/', [
            'as'   => 'showEventExhibitorAttendees',
            'uses' => 'EventAttendeesExhibitorController@showAttendees',
            ]);

            Route::get('{event_id}/check_in', [
            'as'   => 'showChechInExhibitor',
            'uses' => 'EventCheckInExhibitorController@showCheckIn',
            ]);

            Route::get('{event_id}/widgets', [
            'as'   => 'showEventWidgetsExhibitor',
            'uses' => 'EventWidgetsExhibitorController@showEventWidgets',
            ]);


            Route::get('{event_id}/attendees/invite', [
            'as'   => 'showInviteAttendeeExhibitor',
            'uses' => 'EventAttendeesExhibitorController@showInviteAttendee',
            
            ]);

            Route::post('{event_id}/attendees/invite', [
                'as'   => 'postInviteAttendeeExhibitor',
                'uses' => 'EventAttendeesExhibitorController@postInviteAttendee',
            ]);


            Route::get('{event_id}/attendees/print', [
                'as'   => 'showPrintAttendeesExhibitor',
                'uses' => 'EventAttendeesExhibitorController@showPrintAttendees',
            ]);
           
            Route::get('{event_id}/attendees/export/{export_as?}', [
                'as'   => 'showExportAttendeesExhibitor',
                'uses' => 'EventAttendeesExhibitorController@showExportAttendees',
            ]);
