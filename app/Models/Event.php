...
class Event extends MyBaseModel
{
    ...
    /**
     * The statsExhibitors associated with the event.
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     */
    public function statsExhibitors()
    {
        return $this->hasMany(\App\Models\EventStatsExhibitor::class);
    }
    ...
    public function organiser()
    {
     ...
     /**
     * The Exhibitor associated with the event.
     *
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     */
    public function exhibitors()
    {
        return $this->belongsTo(\App\Models\Exhibitor::class);
    }
