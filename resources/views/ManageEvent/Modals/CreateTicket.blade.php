                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="form-group">
                                    <div class="custom-checkbox">
                                        {!! Form::checkbox('access_code', 1,  false , ['data-toggle' => 'toggle', 'id' => 'access_code']) !!}
                                        <label for="access_code">Access Code</label>
                                    </div>
                                </div>
                                <div class="form-group access_code_details" style="display: none;">
                                    {!! Form::generateCode(null,null,null) !!}
                                    <!-- {!! Form::text('acces_code_detail', null, ['class' => 'form-control']) !!} -->
                                </div>
                            </div>
                        </div>
