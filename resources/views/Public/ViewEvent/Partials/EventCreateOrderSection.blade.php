<section id='order_form' class="container">
    <div class="row">
        <h1 class="section_head orderform">
            Order Details
        </h1>
    </div>
    <div class="row">
        <div class="col-md-4 col-md-push-8">
            <div class="panel">
                <div class="panel-heading orderSummary">
                ...
                <div class="panel-body pt0 orderSummaryList">
        ...
        <div class="col-md-8 col-md-pull-4">
            <div class="event_order_form">
                ...
                <h3 class="orderInformation">Your Information</h3>

                <div class="row">
                    <div class="col-xs-6">
                        <div class="form-group">
                            {!! Form::label("order_first_name", 'First Name') !!}
                            {!! Form::text("order_first_name", null, ['required' => 'required', 'class' => 'form-control orderForm1']) !!}
                        </div>
                    </div>
                    <div class="col-xs-6">
                        <div class="form-group">
                            {!! Form::label("order_last_name", 'Last Name') !!}
                            {!! Form::text("order_last_name", null, ['required' => 'required', 'class' => 'form-control orderForm1']) !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            {!! Form::text("order_email", null, ['required' => 'required', 'class' => 'form-control orderForm1']) !!}
                        </div>
                    </div>
                </div>

                <div class="p20 pl0">
                    <a href="javascript:void(0);" class="btn btn-primary btn-xs ticketholder" id="mirror_buyer_info">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="ticket_holders_details" >
                            <h3 class="totalholder">Ticket Holder Information</h3>
                            <?php
                            ...
                            <fieldset class="fieldset">
                                     ...
                                     <legend class="legendata">

                                        {{$ticket['ticket']['title']}}Ticket Holder {{$i+1}} Details

                                     </legend>
                                <div class="panel panel-primary listTicket">

                                    <div class="panel-body listTicket1">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group lableName">
                                                    {!! Form::label("ticket_holder_first_name[{$i}][{$ticket['ticket']['id']}]", 'First Name') !!}
                                                    {!! Form::text("ticket_holder_first_name[{$i}][{$ticket['ticket']['id']}]", null, ['required' => 'required', 'class' => "orderForm12 ticket_holder_first_name.$i.{$ticket['ticket']['id']} ticket_holder_first_name form-control"]) !!}
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group lableName">
                                                    {!! Form::label("ticket_holder_last_name[{$i}][{$ticket['ticket']['id']}]", 'Last Name') !!}
                                                    {!! Form::text("ticket_holder_last_name[{$i}][{$ticket['ticket']['id']}]", null, ['required' => 'required', 'class' => "orderForm12 ticket_holder_last_name.$i.{$ticket['ticket']['id']} ticket_holder_last_name form-control"]) !!}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group lableName">
                                                    ...
                                                    {!! Form::text("ticket_holder_email[{$i}][{$ticket['ticket']['id']}]", null, ['required' => 'required', 'class' => "orderForm12 ticket_holder_email.$i.{$ticket['ticket']['id']} ticket_holder_email form-control"]) !!}
                                                </div>
                                            </div>
            ...
            {!! Form::submit('Checkout', ['class' => 'btn btn-lg btn-success card-submit ordercard', 'style' => 'width:100%;']) !!}
