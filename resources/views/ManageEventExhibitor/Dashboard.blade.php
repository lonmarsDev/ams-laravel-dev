...
@section('head')
    ...
    <script>
        $(function () {
            $.getJSON('http://graph.facebook.com/?id=' + '{{route('showEventPage',['event_id' => $event->id, 'event_slug' => Str::slug($event->title)])}}?access_code={{$exhibitor_access_code}}', function (fbdata) {
...
@section('content')
    <div class="row">
        <!-- <div class="col-sm-3">
            <div class="stat-box">
                <h3>{{ money($exhibitor_sales_volume + $exhibitor_organiser_fee_volume, $event->currency) }}</h3>
        ...
        <div class="col-sm-3">
            <div class="stat-box">
                <h3>{{ $exhibitor_ticket_sold }}</h3>
                <span>Tickets Sold</span>
            </div>
        </div>
        <div class="col-sm-3">
            <div class="stat-box">
                <h3>{{ $exhibitor_event_view }}</h3>
    ...
    <div class="row">
                    ...
                    <div class="panel">
                        <div class="panel-heading panel-default">
                            <h3 class="panel-title">
                                Ticket Sales Volume
                                <span style="color: green; float: right;">
                                    {{ money($exhibitor_sales_volume + $exhibitor_organiser_fee_volume, $event->currency) }}
                                    Total
                                </span>
                            </h3>
                        </div>
        ...
        <div class="col-md-3 col-sm-6">
            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    {!! Form::input('text', 'front_end_url', $event->event_url . '?access_code='. $exhibitor_access_code , ['class' => 'form-control', 'onclick' => 'this.select();']) !!}
                </div>
                ...
                <div class="panel-body">
                    <ul class="rrssb-buttons clearfix">
                        <li class="rrssb-facebook">
                            <a href="https://www.facebook.com/sharer/sharer.php?u={{$event->event_url}}?access_code={{$exhibitor_access_code}}&utm_source=fb"
                               class="popup">
                        ...
                        <li class="rrssb-linkedin">
                            <a href="http://www.linkedin.com/shareArticle?mini=true&amp;url={{$event->event_url}}?access_code={{$exhibitor_access_code}}&utm_source=linkedin&amp;title={{urlencode($event->title)}}&amp;summary={{{Str::words(strip_tags($event->description), 20)}}}"
                               class="popup">
                            <span class="rrssb-icon">
                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                                     xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="28px"
                        ...
                        <li class="rrssb-twitter">
                            <a href="http://twitter.com/intent/tweet?text=Check out: {{$event->event_url}}?access_code={{$exhibitor_access_code}}&utm_source=twitter {{ Str::words(strip_tags($event->description)), 20 }}"
                               class="popup">
                            <span class="rrssb-icon">
                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <li class="rrssb-googleplus">
                            <a href="https://plus.google.com/share?url={{$event->event_url}}?access_code={{$exhibitor_access_code}}&utm_source=googleplus"
                               class="popup">
                            <span class="rrssb-icon">
                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                                     xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="28px"
                        ...
                        <li class="rrssb-email">
                            <a href="mailto:?subject=Check This Out&body={{urlencode($event->event_url)}}?access_code={{$exhibitor_access_code}}&utm_source=email">
                            <span class="rrssb-icon">
