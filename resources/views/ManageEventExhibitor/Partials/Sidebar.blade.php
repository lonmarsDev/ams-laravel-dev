    ...
    <section class="content">
        ...
        <ul id="nav_event" class="topmenu">
            <li class="{{ Request::is('*dashboard*') ? 'active' : '' }}">
                <a href="{{route('showEventExhibitorDashboard', array('event_id' => $event->id))}}">
          ...
          <!--   <li class="{{ Request::is('*tickets*') ? 'active' : '' }}">
           ...
           <!--  <li class="{{ Request::is('*orders*') ? 'active' : '' }}">
            ...
            <li class="{{ Request::is('*attendees*') ? 'active' : '' }}">
                <a href="{{route('showEventExhibitorAttendees', array('event_id' => $event->id))}}">
        ...
        <ul id="nav_event" class="topmenu">
            <li class="{{ Request::is('*check_in*') ? 'active' : '' }}">
                <a href="{{route('showChechInExhibitor', array('event_id' => $event->id))}}">
                    <span class="figure"><i class="ico-checkbox-checked"></i></span>
                    <span class="text">Attendees Check-In Status</span>
                </a>
            </li>
           <!--  <li class="{{ Request::is('*surveys*') ? 'active' : '' }}">
            ...
            <li class="{{ Request::is('*widgets*') ? 'active' : '' }}">
                <a href="{{route('showEventWidgetsExhibitor', array('event_id' => $event->id))}}">
